 ...
 * @param   $default mixed  Default value to return if the key is not present in the
 *                  array.
 ...
 * @param   $method string|null   Determines which **values** will appear in the result
 ...
 * @param   $keyMethod string|null   Determines how **keys** will be assigned in the result
 ...
 * @param   $index mixed|null   Determines which **values** will appear in the result
 *                        array. Use a scalar to select that index from each
 *                        array, or null to preserve the arrays unmodified as
 *                        values.
 * @param   $keyIndex string|null   Determines which **keys** will appear in the result
 *                        array. Use a scalar to select that index from each
 ...
 * @param   $by string  Name of a method, like 'getType', to call on each object
 ...
 * @param   $by string  Name of an index to select from each array in order to
 ...
 * @param   $method string  Name of a method to call on each object; the return values
 ...
 * @param  $negate bool         Optionally, pass true to drop objects which pass the
 ...
 * @param  $negate bool         Optionally, pass true to drop arrays which pass the
 *                      filter instead of keeping them.
 *
